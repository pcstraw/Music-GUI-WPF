...
{
    public class MSTreeViewItem : TreeViewItem
    {
        ...
        /// </summary>
        public MSTreeView ParentMultipleSelectionTreeView
        {
            get
            {
                ...
                {
                    MSTreeView view = container as MSTreeView;
                    if (view != null)
                    {
                        return view;
                    }
        ...
        /// </summary>
        public MSTreeViewItem ParentMultipleSelectionTreeViewItem
        {
            get
            {
                return (this.ParentItemsControl as MSTreeViewItem);
            }
        }
        #endregion

        #region Constructors
        static MSTreeViewItem()
        {
            DefaultStyleKeyProperty.OverrideMetadata(
                    typeof(MSTreeViewItem), new FrameworkPropertyMetadata(typeof(MSTreeViewItem)));
        }

        public MSTreeViewItem()
        {
        ...
        public MSTreeViewItem GetPreviousNodeAtSameLevel(MSTreeViewItem item)
        {
            if (item == null)
                return null;

            MSTreeViewItem previousNodeAtSameLevel = null;
            ...
            if (parentControl != null)
            {
                ...
                {
                    previousNodeAtSameLevel = parentControl.ItemContainerGenerator.ContainerFromIndex(index - 1) as MSTreeViewItem;
                }
            }
        ...
        public MSTreeViewItem GetParentTreeViewItem()
        {
            try
            {
                var parent = VisualTreeHelper.GetParent(this as DependencyObject);
                while ((parent as MSTreeViewItem) == null)
                {
                    parent = VisualTreeHelper.GetParent(parent);
                }
                return parent as MSTreeViewItem;
            }
            catch (Exception e)
            {
        ...
        {
            return ItemContainerGenerator.ContainerFromItem(item) as MSTreeViewItem;
        }
